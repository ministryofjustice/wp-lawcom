...
if ( !function_exists( 'ot_recognized_font_sizes' ) ) {
	...
	function ot_recognized_font_sizes( $field_id ) {
		...
		$range = ot_range(
				apply_filters( 'ot_font_size_low_range', 0, $field_id ), apply_filters( 'ot_font_size_high_range', 150, $field_id ), apply_filters( 'ot_font_size_range_interval', 1, $field_id )
		);
...
if ( !function_exists( 'ot_recognized_letter_spacing' ) ) {
	...
	function ot_recognized_letter_spacing( $field_id ) {
		...
		$range = ot_range(
				apply_filters( 'ot_letter_spacing_low_range', -0.1, $field_id ), apply_filters( 'ot_letter_spacing_high_range', 0.1, $field_id ), apply_filters( 'ot_letter_spacing_range_interval', 0.01, $field_id )
		);
...
if ( !function_exists( 'ot_recognized_line_heights' ) ) {
	...
	function ot_recognized_line_heights( $field_id ) {
		...
		$range = ot_range(
				apply_filters( 'ot_line_height_low_range', 0, $field_id ), apply_filters( 'ot_line_height_high_range', 150, $field_id ), apply_filters( 'ot_line_height_unit_type', 1, $field_id )
		);
